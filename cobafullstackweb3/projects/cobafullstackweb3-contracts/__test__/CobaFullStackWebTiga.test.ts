...
import { CobaFullStackWebTigaClient } from '../contracts/clients/CobaFullStackWebTigaClient';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: CobaFullStackWebTigaClient;

describe('CobaFullStackWebTiga', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new CobaFullStackWebTigaClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
